...
function MakeOwn() {
  return (
    <div className='items-center justify-center w-full border-y-2 border-black flex flex-col space-y-14 px4 py-36'>
        <h1 className='2xl:text-8xl lg:text-4xl text-2xl max-w-1/2 w-1/2 text-center'>
            Make your own Road
        </h1>
        <h1 className='2xl:text-4xl text-xl 2xl:max-w-1/2 2xl:w-[60%] text-cemter leading-snug max-xl:px-4'>
