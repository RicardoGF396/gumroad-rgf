...
function Discover() {
  return (
    <main className='h-full lg:px-12 w-full my-12 items-start justify-center py-3 px-2'>
        <h1 className='lg:text-7xl text-4xl w-full text-center py-12'>Discover the best things to read, watch, make, and more!</h1>
        <div className='grid grid-cols-1 xl:grid-cols-3 lg:px-12 gap-4 place-items-start w-full '>
            {discoverDB.map((item) => (
